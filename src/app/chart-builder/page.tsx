...
export default function ChartBuilderPage() {
  ...
  useEffect(() => {
    apiFetch<JiraProject[]>('/api/jira/projects').then(setProjects).catch((err) => setError(err.message));
  }, []);
  ...
  return (
    <div className="stack">
      <section className="card stack">
        ...
        <p>Construtor visual consumindo dados do Jira via API.</p>
      ...
      <section className="card stack">
        ...
        <div className="grid">
          <label className="stack">Tipo de visualização
